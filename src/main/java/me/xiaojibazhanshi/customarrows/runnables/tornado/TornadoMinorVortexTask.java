...
public class TornadoMinorVortexTask implements Consumer<BukkitTask> {
    ...
    public TornadoMinorVortexTask(Location location, int durationInSeconds, int chosenPeriod) {
